...
public:
  ...
  explicit solver_main(Args && ...args) : m_solver(std::forward<Args>(args)...) {
  }
...
int main(int argc, const char **argv)
{
  try {
    ...
    const std::map<std::string, solver_kind> solver_kind_map = {{"trivial_sat", solver_kind::trivial_sat}, {"cdcl_sat", solver_kind::cdcl_sat}};
