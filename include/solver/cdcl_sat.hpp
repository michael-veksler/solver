 ...
 */
inline std::vector<cdcl_sat::variable_handle> create_variables(cdcl_sat &solver, unsigned num_vars)
{
...
inline void cdcl_sat::set_domain(variable_handle var, binary_domain domain, clause_handle by_clause)
{
  if (get_debug()) {
...
inline cdcl_sat::conflict_analysis_algo::conflict_analysis_algo(cdcl_sat &solver_in,
...
inline void cdcl_sat::conflict_analysis_algo::resolve(variable_handle pivot_var)
{
...
inline std::string cdcl_sat::conflict_analysis_algo::to_string() const
{
  std::string ret = "{";
  const char *sep = "";
...
inline auto cdcl_sat::analyze_conflict(clause_handle conflicting_clause)
...
inline solve_status cdcl_sat::solve()
{
...
inline void cdcl_sat::validate_all_singletons() const
{
...
inline auto cdcl_sat::find_free_var(variable_handle search_start) const -> std::optional<variable_handle>
{
...
inline bool cdcl_sat::make_choice()
{
...
inline bool cdcl_sat::initial_propagate()
{
...
inline auto cdcl_sat::propagate() -> std::optional<clause_handle>
{
...
inline auto cdcl_sat::clause::linear_find_free_literal(const cdcl_sat &solver,
...
inline solve_status cdcl_sat::clause::literal_state(const cdcl_sat &solver, literal_index_t literal_num) const
{
  const variable_handle var = get_variable(literal_num);
  const bool is_positive = is_positive_literal(literal_num);
  const binary_domain domain = solver.get_current_domain(var);
...
inline bool cdcl_sat::clause::remove_duplicate_variables()
{
...
inline solve_status cdcl_sat::clause::initial_propagate(propagation_context propagation)
{
...
inline auto cdcl_sat::clause::find_different_watch(const cdcl_sat &solver, unsigned watch_index) const
  -> literal_index_t
{
...
inline solve_status cdcl_sat::clause::propagate(propagation_context propagation, variable_handle triggering_var)
{
  assert(m_watched_literals[0] < m_watched_literals[1] && m_watched_literals[1] < size());// NOLINT
...
inline solve_status cdcl_sat::clause::unit_propagate(propagation_context propagation, literal_index_t literal_num) const
{
  const variable_handle var = get_variable(literal_num);
  const bool is_positive = is_positive_literal(literal_num);
...
inline void cdcl_sat::backtrack(level_t backtrack_level)
{
  assert(get_level() > 0);
